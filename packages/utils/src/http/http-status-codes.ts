...
export const INSUFFICIENT_SPACE_ON_RESOURCE: number = 419;
...
export const METHOD_FAILURE: number = 420;
...
export const REQUEST_TOO_LONG: number = 413;
export const REQUEST_URI_TOO_LONG: number = 414;
